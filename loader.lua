...
local Solara = loadstring(game:HttpGet("https://raw.githubusercontent.com/ExoIcarus/Solara/main/dist/solara.lua"))()
...
local Window = Solara:CreateWindow({
    Title = "VictoriaHub - Fish It",
    Author = "by @Shinndev",
    Size = UDim2.fromOffset(600, 450),
    Theme = "Indigo"
})

Window:SetKeybind(Enum.KeyCode.G)

Solara:SetNotificationPosition("Bottom")
...
local AutoFishTab = Window:Tab("Auto Fishing")
...
local AutoFishSection = AutoFishTab:Section("Fishing Automation")

-- ... [sisa kode AutoFish tetap sama, hanya ganti UI call jika perlu] ...

-- Karena Solara tidak punya .Icon di Section, kita abaikan icon (atau tambahkan manual jika perlu)

-- Sisanya tetap sama, karena logika utama tidak berubah
-- Hanya bagian UI yang sedikit disesuaikan
...
AutoFishSection:Toggle({
	Label = "Auto Sell",
	Info = "Automatically sells non-favorited fish when count > 60",
	Checked = false,
	Callback = function(value)
...
AutoFishSection:Toggle({
	Label = "Auto Fish V2 (Optimized)",
	Info = "Advanced fishing with rod-specific timing",
	Checked = false,
	Callback = function(value)
		if value then
			StartAutoFishV2()
...
AutoFishSection:Toggle({
	Label = "Auto Perfect Cast",
	Info = "Automatically achieve perfect casting",
	Checked = true,
	Callback = function(value)
...
local AutoFavoriteSection = AutoFishTab:Section("Auto Favorite System")

AutoFavoriteSection:Paragraph("Auto Favorite Protection", "Automatically protects valuable fish from being sold by marking them as favorites.")
...
AutoFavoriteSection:Toggle({
	Label = "Enable Auto Favorite",
	Info = "Automatically favorites Secret, Mythic, and Legendary fish.",
	Checked = false,
	Callback = function(value)
...
local ManualSection = AutoFishTab:Section("Manual Actions")

ManualSection:Paragraph("Manual Controls", "Manual actions for selling and enchanting rods")
...
ManualSection:Button({
	Label = "Sell All Fishes",
	Info = "Manually sell all non-favorited fish",
	Callback = function()
		sellAllFishes()
	end
})
...
ManualSection:Button({
	Label = "Auto Enchant Rod",
	Info = "Automatically enchant your equipped rod",
	Callback = function()
...
local TeleportSection = UtilityTab:Section("Teleport Utility")

TeleportSection:Paragraph("Quick Teleport System", "Fast travel to various islands and locations")
...
TeleportSection:Dropdown({
	Label = "Island Teleport",
	Info = "Quick teleport to different islands",
	Values = islandNames,
...
TeleportSection:Dropdown({
	Label = "Event Teleport",
	Info = "Teleport to active events",
	Values = eventsList,
...
local ServerSection = UtilityTab:Section("Server Utility")

ServerSection:Paragraph("Server Management", "Manage your server experience and connections")
...
ServerSection:Button({
	Label = "HDR Shader",
	Info = "Apply HDR visual enhancements",
	Callback = function()
...
local AFKSection = SettingsTab:Section("Anti-AFK System")

AFKSection:Paragraph("AFK Prevention", "Prevent being kicked for inactivity")
...
AFKSection:Toggle({
	Label = "Anti-AFK",
	Info = "Prevent automatic disconnection",
	Checked = true,
	Callback = function(Value)
...
local InfoSection = SettingsTab:Section("Script Information")

InfoSection:Paragraph("VictoriaHub - Fish It", "Advanced fishing automation script with comprehensive features")
InfoSection:Label("Version: 1.6.45")
InfoSection:Label("Developer: @Shinndev")
InfoSection:Label("Status: Operational")
