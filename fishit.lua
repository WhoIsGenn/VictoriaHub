...
-- Main Frame (UKURAN DIKURANGI, LEBIH KOMPAK)
local Frame = Instance.new("Frame")
Frame.Size = UDim2.fromOffset(280, 40)  -- DARI 420x48 JADI 280x40
...
-- Stroke dengan gradient (DIKURANGI THICKNESS)
local Stroke = Instance.new("UIStroke")
Stroke.Thickness = 2  -- DARI 3 JADI 2
...
-- Icon (POSISI DIKURANGI)
local Icon = Instance.new("ImageLabel")
Icon.Size = UDim2.fromOffset(20, 20)  -- DARI 22x22 JADI 20x20
Icon.Position = UDim2.fromOffset(10, 10)  -- DARI (14,13) JADI (10,10)
Icon.BackgroundTransparency = 1
Icon.Image = "rbxassetid://134034549147826"
Icon.Parent = Frame

-- Text (UKURAN DI SESUAIKAN)
local Text = Instance.new("TextLabel")
Text.Size = UDim2.new(1, -35, 1, 0)  -- DARI -60 JADI -35 (karena frame lebih kecil)
Text.Position = UDim2.fromOffset(35, 0)  -- DARI 52 JADI 35
Text.BackgroundTransparency = 1
Text.Font = Enum.Font.GothamBold
Text.TextSize = 12  -- DARI 14 JADI 12 (lebih kecil)
...
RunService.RenderStepped:Connect(function(deltaTime)
    ...
    -- Update setiap 0.5 detik untuk smoothing yang lebih baik
    if frameTime >= 0.5 then
        local currentFPS = frameCount / frameTime
        fpsSmooth = fpsSmooth + (currentFPS - fpsSmooth) * 0.3
        ...
        -- CPU Estimation (FIXED LOGIC)
        -- Ini TIDAK real CPU usage, hanya estimasi!
        local cpuEstimate
        if fpsSmooth >= 60 then
            cpuEstimate = math.random(40, 50)
        elseif fpsSmooth >= 30 then
            cpuEstimate = math.random(50, 70)
        else
            cpuEstimate = math.random(70, 90)
        end
        
        cpuSmooth = cpuSmooth + (cpuEstimate - cpuSmooth) * 0.2
...
-- TOGGLE FUNCTION (SESUAI DENGAN FORMAT AWAL ANDA)
-- Ganti dengan library Anda (Rayfield/WindUI dll)
player:Toggle({
    Title = "Ping Display",
    Default = true,
    Callback = function(v)
...
-- OPSIONAL: Hotkey untuk toggle (Shift + P)
