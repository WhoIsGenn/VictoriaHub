...
local WebhookConfig = {
    ...
    ScriptName = "Victoria Hub | Fish It", 
    EmbedColor = 65535 
}
    ...
    Buttons = {
        {
            ...
            Callback = function()
                if setclipboard then
                    setclipboard("https://discord.gg/comingsooonnnnn")
        ...
        Buttons = {
            {
                ...
                Icon = "link",
                Callback = function()
                    setclipboard("https://discord.gg/comingsoooonnn")
                    WindUI:Notify({
                        Title = "Link Disalin!",
...
function sendNewFishWebhook(newlyCaughtFish)
    ...
    local payload = {
        ...
        embeds = {{
            ...
            url = "https://discord.gg/comingsooonnn",
            color = 65535,
...
local P = game:GetService("Players").LocalPlayer
local HN, HL = "discord.gg/comingsooonn", "Lv. ???"
