...
-- ======================================================
-- AUTO TOTEM (SAFE WINDUI VERSION)
-- ======================================================
...
task.spawn(function()
    ...
    for i = 1, 200 do
        ...
        if DataReplion and DataReplion:Get("Inventory") then
            break
        end
        task.wait(0.05)
    end
    ...
    if not DataReplion then
        warn("[AutoTotem] DataReplion not ready")
        return
    end
    ...
    -- SECTION
    -- ===============================
    local autoTotem = Tab4Ref:Section({
        Title = "Auto Totem",
        Icon = "zap",
        TextXAlignment = "Left",
        TextSize = 17,
