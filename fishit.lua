...
Text.Position = UDim2.fromOffset(35, 0)
...
RunService.RenderStepped:Connect(function()
    ...
    if dt > 0 then
        ...
        local cpu = math.floor(100 - (fps / 2) + 15)
        
        if fps > 200 then fps = 200 end
        if cpu > 95 then cpu = 95 end
        if cpu < 10 then cpu = 10 end
...
print("✅ Performance HUD Loaded (No Drag)")
