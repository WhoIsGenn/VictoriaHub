...
-- ======================================================
-- SKIN ANIMATION (FULL FIX WINDUI)
-- ======================================================
...
task.spawn(function()
    ...
    -- WAIT TAB3
    -- ===============================
    while not _G.WindUI_Tab3 do
        task.wait()
    end
    local Tab3 = _G.WindUI_Tab3
    ...
    -- FISH CAUGHT EVENT
    -- ===============================
    Net:WaitForChild("RE/FishCaught").OnClientEvent:Connect(function()
...
-- BUY WEATHER EVENT (AUTO LOOP 3 WEATHER)
