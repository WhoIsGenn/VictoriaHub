...
-- =====================================
-- FLOATING ICON (WINDUI GLOBAL SAFE)
-- =====================================
...
-- cari ScreenGui WindUI
local function getWindUIGui()
    for _,v in ipairs(PlayerGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name:lower():find("wind") then
            return v
        end
    end
end
...
gui.Name = "Victoria_FloatingIcon"
gui.ResetOnSpawn = false
