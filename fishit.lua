...
-- =========================
-- LEGIT AUTO CLICK (RAW & FAST)
-- =========================
local shakeThread

local function rawClick()
    if VIS then
        -- PC / executor
        for i = 1, 4 do
...
local function startAutoClick()
    ...
    shakeThread = task.spawn(function()
        while _G.AutoFishing and mode == "Legit" and _G.AutoShake do
            rawClick()
            task.wait(0.025) -- 🔥 spam kenceng
        end
    end)
end
